...
#create a file is created to rename the chromosomes so that harmonisation to other datasets is easier
...
bcftools annotate --rename-chrs hg38_rename_chrom_names.tsv --output-type z --output dbSNP_clean.vcf.gz dbsnp.v153.hg38.vcf.gz 
